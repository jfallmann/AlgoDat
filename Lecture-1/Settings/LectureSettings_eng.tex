...
{Planned: Date, From - To, Room}
\def\LectureOrganisationTutors
{{\color{Mittel-Blau}Firstname Name} and {\color{Mittel-Blau}Firstname Name}}
\def\LectureOrganisationAdditional
  {{\color{Mittel-Blau}Firstname Name}}

\def\LectureOrganisationExercisesWorkingTime
{ESE: {\color{Mittel-Blau}1 week}, IEMS: {\color{Mittel-Blau}3 weeks}}